...
$label = 'Get: ';
// value1
var_dump($label . Arrays::get($array, 'key1'));
// default1
var_dump($label . Arrays::get($array, 'key4', 'default1'));
echo PHP_EOL;

// Example: pull key
$label = 'Pull key: ';
// value1
var_dump($label . Arrays::pullKey($array, 'key1'));
var_dump($array);
// default1
var_dump($label . Arrays::pullKey($array, 'key4', 'default1'));
var_dump($array);
echo PHP_EOL;
...
$label = 'Replace empty not empty data: ';
...
var_dump($label . Arrays::toString([
    'option1' => 'value1',
    'option2' => 'value2',
]));
